...
((SELECT dog_id FROM Dogs WHERE name = "Max"), "2025-06-22 11:30:00", 30, "North Terrace", "open"),
((SELECT dog_id FROM Dogs WHERE name = "Max"), "2025-06-21 9:00:00", 30, "North Terrace", "open");